...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(ConstItemMore ConstItemMore) { }
    public void visit(VarItemMore VarItemMore) { }
    public void visit(MethodDeclList MethodDeclList) { }
    public void visit(MethodDeclList_epsilon MethodDeclList_epsilon) { visit(); }
    public void visit(MethodDeclList_methods MethodDeclList_methods) { visit(); }
    public void visit(VarItemMore_epsilon VarItemMore_epsilon) { visit(); }
    public void visit(VarItemMore_comma VarItemMore_comma) { visit(); }
    ...
    public void visit(ConstItemMore_epsilon ConstItemMore_epsilon) { visit(); }
    public void visit(ConstItemMore_comma ConstItemMore_comma) { visit(); }
